...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>UNSW Virtual Server</title>
					...
					<div id="navbar" class="navbar-collapse collapse">
					  ...
					  <div id="centerDiv">
    					<ul class="centerUL">
							...
							<li <?php echo $playActive; ?>><a href="community.php">Community&nbsp;&nbsp;</a></li>
							<li <?php echo $blogActive; ?>><a href="blog.php">Help&nbsp;&nbsp;</a></li>
							<li <?php echo $rulesActive; ?>><a href="rules.php">Legal&nbsp;&nbsp;</a></li>
							<li <?php echo $membershipActive; ?>><a href="membership.php">Social&nbsp;&nbsp;</a></li>
